    ...
    return (
        <div className='bodyOverview flex-col p-3 rounded-xl transition ease-in-out '>
            ...
            <div className='postDiv flex mb-10 shadow-xl shadow-gray-900 mt-3 bg-purple-400 rounded-xl border-purple-700 text-purple-900 p-6'>
                ...
                w-full h-80 text-4xl shadow-xl shadow-gray-900 font-bold  rounded-xl bg-purple-200
                text-purple-900 border-purple-800 hover:bg-purple-300
                cursor-pointer' > Post Project to SQLite Database</button>
                </div>
                <div className='formContainer block text-center w-1/2 h-80 overflow-y-auto'>
                    <form id="postForm" className='formClass pt-6 pl-5 w-full' onSubmit={fetchDataPost}>
                        ...
                        <input className='ml-4 w-2/3 rounded-full shadow-md shadow-gray-900 bg-purple-200' placeholder='    Enter Project Name...' type="text" id="projectName" />
                        <br />
                        <label className='inline-block whitespace-nowrap m-1 mb-5 w-24 text-right'> Manager: </label>
                        <input className='ml-4 w-2/3 rounded-full shadow-md shadow-gray-900 bg-purple-200 ' placeholder='    Enter Manager Name...' type="text" id="manager" />
                        <br />
                        <label className='inline-block whitespace-nowrap m-1 mb-5 w-24 text-right'> Author: </label>
                        <input className='ml-4 w-2/3 rounded-full shadow-md shadow-gray-900 bg-purple-200 ' placeholder='    Enter Author Name...' type="text" id="author" />
                        <br />
                        <label className='inline-block whitespace-nowrap m-1 mb-5 w-24 text-right'> Git URL: </label>
                        <input className='ml-4 w-2/3 rounded-full shadow-md shadow-gray-900 bg-purple-200' placeholder='    Enter Git URL...' type="text" id="gitUrl" />
                        <br />
                        <label className='inline-block whitespace-nowrap m-1 mb-5 w-24 text-right'> Project Stack: </label>
                        <input className='ml-4 w-2/3 rounded-full shadow-md shadow-gray-900 bg-purple-200' placeholder='    Enter Project Stack...' type="text" id="projectStack" />
                        <br />
                        <label className='inline-block whitespace-nowrap m-1 mb-5 w-24 text-right'> Description: </label>
                        <input className='ml-4 w-2/3 rounded-full shadow-md shadow-gray-900 bg-purple-200' placeholder='    Enter Description...' type="text" id="description" />
                        <br />
                    </form>
                </div>
            </div>
            <div className='deletDivSpecific shadow-xl shadow-gray-900 flex mt-3 mb-10 rounded-xl blue-900 bg-blue-400 p-6'>
                ...
                w-1/2 h-80 text-4xl' onClick={() => fetchDataDelete(parseInt((document.getElementById("idNumber") as HTMLInputElement).value))}>
                    Delete Project in from SQLite Database By ID </button>
                <div className='flex w-1/2 items-center justify-center'>
                    <label className=''> Project ID: </label>
                    <input placeholder='0' type="number" id="idNumber" className='ml-4 pl-3 w-16 text-center rounded-md shadow-md shadow-gray-900 bg-blue-100 text-5xl py-2' />
                </div>
            </div>
            <div className='deleteDiv flex shadow-xl shadow-gray-900 rounded-xl mb-10 p-6 bg-pink-400 mt-3 border-pink-900'>
                <button className='deleteButton transition ease-in-out hover:-translate-y-1 duration-300 w-full h-80 text-4xl rounded-xl shadow-xl
                shadow-gray-900 border-pink-900 font-bold bg-pink-200
                hover:bg-pink-300 text-pink-900 cursor-pointer' onClick={() => fetchDataDelete(0)}> Delete Last Project from SQLite Database</button>
            </div>
        </div >
    );
}
