...
const Profile = () => {
  return (
    <div className="flex h-screen bg-mountain bg-center bg-fixed">
      <div className="flex flex-col relative items-center w-full h-full gap-32 ">
        <div className="flex w-full max-w-screen-2xl ">
          <div className="HoverGroupContainer flex flex-col w-96 group mt-20 ">
            <div className=" flex ml-14 flex-col w-96 h-24 max-w-lg ">
        ...
        <div className="flex w-full justify-center">
          <div className="HoverGroupContainer relative flex flex-col items-center justify-center group w-3/4 h-96">
            <div className="HiBackground max-w-3xl absolute w-full h-60 blur-md group-hover:blur-2xl duration-500 bg-gradient-to-br from-blue-700 to-purple-600 justify-center items-center"></div>
            <div className=" Hi h-60 gap-28 max-w-3xl w-full flex flex-col  font-serif text-xl rounded-xl items-center relative bg-black text-slate-300 text-center ">
